...
## Area Under Receriver Operating Characteristic Curves
...
```
<footer> [Learn more about ROC Curves](https://en.wikipedia.org/wiki/Receiver_operating_characteristic) </footer> 
